...
import { adminLoginOtpRequestSchema, adminLoginOtpVerifySchema, forgotPasswordSchema, loginSchema, registerSchema, resetPasswordSchema, verifyEmailSchema } from "../validation/auth.validation.js";
...
router.post("/auth/admin/request-otp", authRateLimiter, validate({ body: adminLoginOtpRequestSchema }), authController.requestAdminOtp);
router.post("/auth/admin/verify-otp", authRateLimiter, validate({ body: adminLoginOtpVerifySchema }), authController.verifyAdminOtp);
