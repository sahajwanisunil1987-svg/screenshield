...
export const exportProductsForBulkEditing = async (_req: Request, res: Response) => {
  res.json(await catalogService.exportProductsForBulkEditing());
};
...
export const checkBulkProductSkus = async (req: Request, res: Response) => {
